...
func (p *Packer) TgzTo(ctx context.Context, kpkg *v1alpha1.KubePkg, w io.Writer) (dgst digest.Digest, err error) {
	...
	if err := p.writeTo(ctx, tw, kpkg); err != nil {
		return "", err
	}
...
func (p *Packer) writeTo(ctx context.Context, tw *tar.Writer, kpkg *v1alpha1.KubePkg) error {
	if err := p.writeKubePkgTo(ctx, tw, kpkg); err != nil {
		return err
	}
...
func (p *Packer) writeKubePkgTo(ctx context.Context, tw *tar.Writer, kpkg *v1alpha1.KubePkg) error {
