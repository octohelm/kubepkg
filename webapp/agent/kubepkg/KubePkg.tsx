import { KubePkg, listKubePkg } from "../../client/agent";
import { Subscribe, useObservableEffect, useRequest, useStateSubject } from "@innoai-tech/reactutil";
...
export const KubePkgQuerier = () => {
  ...
  const list$ = useStateSubject<KubePkg[]>([]);
