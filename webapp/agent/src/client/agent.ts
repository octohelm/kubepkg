...
export const uploadBlob = /*#__PURE__*/ createRequest<
  ...
  null
>("agent.UploadBlob", ({ "Content-Type": header_contentType, body: body }) => ({
  method: "PUT",
  url: "/api/kubepkg-agent/v1/blobs",
  headers: {
...
export const statBlob = /*#__PURE__*/ createRequest<
  ...
  null
>("agent.StatBlob", ({ digest: path_digest }) => ({
  method: "GET",
  url: `/api/kubepkg-agent/v1/blobs/${path_digest}/stat`,
}));
...
>("agent.ListKubePkg", () => ({
  method: "GET",
  url: "/api/kubepkg-agent/v1/kubepkgs",
}));
...
export const applyKubePkg = /*#__PURE__*/ createRequest<
  ...
  KubepkgV1Alpha1KubePkg
>("agent.ApplyKubePkg", ({ body: body, "Content-Type": contentType }) => ({
  method: "PUT",
  url: "/api/kubepkg-agent/v1/kubepkgs",
  body: body,
  headers: {
...
export const delKubePkg = /*#__PURE__*/ createRequest<
  ...
  null
>("agent.DelKubePkg", ({ name: path_name, namespace: query_namespace }) => ({
  method: "DELETE",
  url: `/api/kubepkg-agent/v1/kubepkgs/${path_name}`,
  params: {
...
export const getKubePkg = /*#__PURE__*/ createRequest<
  ...
  KubepkgV1Alpha1KubePkg
>("agent.GetKubePkg", ({ name: path_name, namespace: query_namespace }) => ({
  method: "GET",
  url: `/api/kubepkg-agent/v1/kubepkgs/${path_name}`,
  params: {
    namespace: query_namespace,
