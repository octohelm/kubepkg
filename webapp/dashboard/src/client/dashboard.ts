...
>(
  "dashboard.GetClusterStatus",
  ({ authorization: query_authorization, name: path_name }) => ({
    method: "GET",
...
export const getGroupEnvClusterStatus = /*#__PURE__*/ createRequest<
  {
    authorization?: string;
    groupName: string;
    envName: string;
  ...
  null
>(
  "dashboard.GetGroupEnvClusterStatus",
  ({
    authorization: query_authorization,
    groupName: path_groupName,
    envName: path_envName,
    ...
    method: "GET",
    url: `/api/kubepkg-dashboard/v0/groups/${path_groupName}/envs/${path_envName}/clusters/${path_clusterId}/status`,
    params: {
      authorization: query_authorization,
    },
  })
...
export const RawOpenAPI = {
  ...
  paths: {
    ...
    "/api/kubepkg-dashboard/v0/groups/{groupName}/envs/{envName}/clusters/{clusterID}/status":
      {
        get: {
          tags: ["group"],
          operationId: "GetGroupEnvClusterStatus",
          parameters: [
            {
              name: "Authorization",
              in: "header",
  ...
  components: {
    schemas: {
      ...
      ClusterInstanceStatus: {
        ...
        required: ["id", "ping", "supportedPlatforms"],
      },
      ClusterNetType: {
        type: "string",
        enum: ["DIRECT", "AIRGAP"],
